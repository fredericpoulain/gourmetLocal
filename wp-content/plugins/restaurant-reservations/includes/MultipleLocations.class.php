	...
	class rtbMultipleLocations {
		...
		public function print_location_metabox( $post ) {
			...
			if ( $term_id ) {
				...
				if ( $admin_email_option or $rtb_controller->permissions->check_permission( 'advanced' ) ) {
			...
			<?php if ( $admin_email_option or $rtb_controller->permissions->check_permission( 'advanced' ) ) : ?>
