...
class sapAdminPageSettingToggle_2_6_21_rtb extends sapAdminPageSetting_2_6_21_rtb {
	...
	public function display_setting() {
		...
		<fieldset <?php $this->print_conditional_data(); ?> <?php $this->print_setting_type_data(); ?>>
			<div class="sap-admin-hide-radios">
				<input type="checkbox" name="<?php echo esc_attr( $input_name ); ?>" id="<?php echo esc_attr( $input_name ); ?>" value="1"<?php if( $this->value == '1' ) : ?> checked="checked"<?php endif; ?> <?php echo ( $this->disabled ? 'disabled' : ''); ?> <?php $this->print_conditional_data(); ?> <?php $this->print_setting_type_data(); ?>>
